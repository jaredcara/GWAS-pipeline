...
def step8(fil):
	...
	os.system("plink --bfile " + fil + "out/step7/step7_2/step7_2 --bmerge " + merge + ".bed " + merge + ".bim " + merge + ".fam --make-bed --out " + fil + "out/step8/step8_1/step8_1")
	#merge QC bfile from previous step 5f with hg19 bed, bim, fam files
	#makes -merge.missnp file

	
	os.system("plink --bfile " + merge + " --exclude " + fil + "out/step8/step8_1/step8_1-merge.missnp --geno 0.1 --make-bed --out " + fil + "out/step8/step8_2/step8_2_HAPMAP")
